...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("gastos",$eli_codigo,"cod_gas");
	if ($error >=1)
...
INNER JOIN grupo_gastos ON grupo_gastos.cod_gru = gastos.tipo_gasto
  $where ";
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_gasto.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="fec_gas">Fecha</option>
							<option value="nom_gas">Tipo de Gasto</option>
							<option value="val_gas">Valor</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
                          <td width="153"  class="ctablasup" >FECHA</td>
						  <td width="156"  class="ctablasup">TIPO GASTO</td>
						  <td width="193"  class="ctablasup">VALOR</td>
                          <td  class="ctablasup"  width="112">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_gasto.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_gas' action='man_gasto.php'>  ";
                          	echo "<td >$db->fecha_gasto</td>";
							echo "<td >$db->nom_gru</td>";
							echo "<td><div align='right'>".number_format($db->valor_gasto,0,",",".")."</div></td>";
...
<form name="forma" method="post" action="con_gasto.php">
