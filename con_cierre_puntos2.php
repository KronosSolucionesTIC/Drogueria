...
function abrir() {	 // cierre normal	
	...
	else 
	{
		...
		var cod_bod = document.getElementById('bodega').value;
		imprimir_inf("inf_cierre_puntos2.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&cod_bod='+cod_bod,'mediano');
	}
}
        ...
        <tr>
          <td><table width="587" border="0"  cellpadding="0" align="center">
              ...
              <? 
						...
						?>
              <tr>
                <td class="ctablablanc" >Punto:</td>
                <td class="ctablablanc" ><? combo_evento_where("bodega","bodega","cod_bod","nom_bod"," ","  ", " where estado_bodega = 1 AND (cod_bod = 340) OR (cod_bod = 363) OR (cod_bod =376) OR (cod_bod =375) OR (cod_bod =225) ORDER BY nom_bod"); ?></td>
                <td class="ctablablanc" ><span class="textorojo">*</span></td>
