...
function abrir() {		
	if(document.getElementById('fec_fin').value == "") {
	...
	else 
	{
		...
		imprimir_inf("consulta_cantidad.php",'0&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto,'mediano');
	}
...
function abrir_rojo() {		
	...
	else 
	{
		...
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_cantidad_rojo.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}
...
function abrir_r_a() {		
	...
	else 
	{
		...
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_cantidad_rojo_ama.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}
...
function abrir_verde() {		
	...
	else 
	{
		...
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_cantidad_verde.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      <td><table width="587" border="0"  cellpadding="0" align="center">
                        <tr>
                          <td colspan="5"  class="ctablasup" >INFORME DE CANTIDADES</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td width="16" class="ctablablanc" >&nbsp;</td>
                          <td width="343" class="ctablablanc" ><div align="center">Fecha Final </div></td>
                          <td width="24" class="ctablablanc" >&nbsp;</td>
                          <td class="ctablablanc" >&nbsp;</td>
                        <tr>
                          <td class="ctablablanc" >&nbsp;</td>
                          <td class="ctablablanc" >&nbsp;</td>
                          <td class="ctablablanc" ><div align="center">
                            <input name="fec_fin" type="text" class="textotabla01" id="fec_fin" readonly  />
                          <img src="imagenes/date.png" alt="Calendario" name="imageField1" width="16" height="16" border="0" id="imageField1" style="cursor:pointer"/></div></td>
                          <td class="ctablablanc" >&nbsp;</td>
...
<form name="forma" method="post" action="con_inf_ventas_cantidad.php">
