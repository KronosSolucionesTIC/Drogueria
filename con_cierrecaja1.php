        ...
        <tr>
          <td><table width="587" border="0"  cellpadding="0" align="center">
              ...
              <tr>
                ...
                <td width="155" class="ctablablanc" ><input name="fecha" type="text" class="textotabla01" id="fec_ini" readonly="1"  />
                ...
                <td width="155" class="ctablablanc" ><input name="fec_fin" type="text" class="textotabla01" id="fec_fin" readonly="1"  />
              ...
              <tr>
                <td colspan="2" class="ctablasup" >Informe Gastos</td>
                <td class="ctablablanc" ><img src='imagenes/mirar.png' alt="." width='16' height='16'  style="cursor:pointer"  onClick="abrir_gastos()" /></td>
                <td class="ctablablanc" >&nbsp;</td>
              </tr>
              <tr>
