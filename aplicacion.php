...
<table width="99%" height="99%" align="center" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="80%" height="100%" valign="top">
      <table width="100%" height="552" border="0">
        <tr>
          <td width="20%" height="548" valign="bottom"><iframe  frameborder="0" scrolling="auto"   src="menucito.php" name="interna_menu" width="99%" height="100%"> </iframe></td>
          <td width="80%" valign="top"><iframe  frameborder="0" scrolling="auto"   src="interna.php" name="interna" width="99%" height="99%"> </iframe></td>     
          </tr>
        </table>
        </td>
  </tr>
