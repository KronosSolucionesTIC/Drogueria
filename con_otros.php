...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("otros_pagos",$eli_codigo,"cod_otro");
	if ($error >=1)
...
$sql="SELECT 
 ...
 FROM   otros_pagos
  ...
  left JOIN tipo_pago ON (tipo_pago.cod_tpag = otros_pagos.cod_tpag_otro) $where  ORDER BY fec_otro DESC  ";
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_otros.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="19"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_otros.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="fec_otro">Fecha</option>
							<option value="nom_bod">Cliente</option>
							<option value="nom_tpag">Tipo de pago</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
                          <td width="81"  class="ctablasup" >FECHA</td>
						  <td width="161"  class="ctablasup">CLIENTE</td>
                           <td width="164"  class="ctablasup">TIPO PAGO</td>
						  <td width="114"  class="ctablasup">VALOR</td>
                          <td  class="ctablasup"  width="92">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_otro_pago.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_otro' action='man_otros.php'>  ";
                          	echo "<td >$db->fec_otro</td>";
							echo "<td >$db->nom_bod $db->apel_bod</td>";
							echo "<td >$db->nom_tpag</td>";
							echo "<td><div align='right'>".number_format($db->val_otro,0,",",".")."</div></td>";
                            echo "<td aling='center' >"; 
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_otro'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.png' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_otro.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.png' width='16' height='16'  /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.png' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_otro) /></td> ";
							else
...
<form name="forma" method="post" action="con_otros.php">
