...
$t_usuario="usuario";
$cant_reg_pag=20;
$nombre_aplicacion=":::: LAS MARCAS.NET :::";
...
class Database
{
	...
	/*var $Host = "marcassistema.db.7656336.hostedresource.com";
    var $Database = "marcassistema";
    var $User     = "marcassistema";
    var $Password = "Marcas2409014@";
    var $R = array();
    var $Row;
    var $Errno    = 0;
    var $Error    = "";
