...
function abrir() {	 // cierre normal	
	...
	else 
	{
		...
		imprimir_inf("inf_estampados.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&usu='+usu,'mediano');
	}
}
    ...
    <td valign="top" ><table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
        <tr>
          <td><table width="587" border="0"  cellpadding="0" align="center">
              <tr>
                <td colspan="5"  class="ctablasup" >CONSULTA ESTAMPADOS</td>
              </tr>
              <? 
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						?>
              <tr>
                <td width="99" class="ctablablanc" >Fecha Inicial </td>
                <td width="178" class="ctablablanc" ><input name="fecha" type="text" class="textotabla01" id="fec_ini" readonly  />
                ...
                <td width="67" class="ctablablanc" >Fecha Final </td>
                <td width="193" class="ctablablanc" ><input name="fec_fin" type="text" class="textotabla01" id="fec_fin" readonly  />
                ...
                <td width="38" class="ctablablanc" ><img src='imagenes/mirar.png' alt="." width='16' height='16'  style="cursor:pointer"  onclick="abrir()" />
                <input type="hidden" name="usu" id="usu" value="<?=$global[2]?>" /></td>
