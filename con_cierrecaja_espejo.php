...
function abrir() {	 // cierre normal	
	...
	//	window.open(ruta,"ventana","menubar=0,resizable=1,width=745,height=500,toolbar=0,scrollbars=yes")
		imprimir_inf("consulta_caja_diara_esp.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin,'mediano');
	}
...
function abrir_gastos() {		// cierre gastos
	if(document.getElementById('fec_fin').value == ""  ||  document.getElementById('fec_ini').value=="") {
	 	alert('Seleccione las Fechas de consulta')
	}
	...
	else 
	{
		var fec_ini = document.getElementById('fec_ini').value;
		var fec_fin = document.getElementById('fec_fin').value;
		imprimir_inf("inf_cierre_pagos.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin,'mediano');
	}
...
function abrir_pagos() { // cierre pagos
	if(document.getElementById('fec_fin').value == ""  ||  document.getElementById('fec_ini').value=="") {
	 	alert('Seleccione las Fechas de consulta')
	}
	...
	else 
	{
		var fec_ini = document.getElementById('fec_ini').value;
		var fec_fin = document.getElementById('fec_fin').value;
		imprimir_inf("inf_cierre_gastos.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin,'mediano');
	}
