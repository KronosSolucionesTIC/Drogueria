...
function abrir() {		
	if(document.getElementById('fec_fin').value == ""  ||document.getElementById('fec_ini').value == ""  ||  document.getElementById('t_despacho').value=="") {
	 	alert('Seleccione las Fechas y el tiempo de despacho en dias')
	}
	...
	else 
	{
		...
		var t_despacho = document.getElementById('t_despacho').value;
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_semaforo.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}
...
function abrir_rojo() {		
	...
	else 
	{
		...
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_semaforo_rojo.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}
...
function abrir_r_a() {		
	...
	else 
	{
		...
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_semaforo_rojo_ama.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}

	
}

function abrir_verde() {		
	if(document.getElementById('fec_fin').value == ""  ||document.getElementById('fec_ini').value == ""  ||  document.getElementById('t_despacho').value=="") {
	 	alert('Seleccione las Fechas y el tiempo de despacho en dias')
	}
	...
	else 
	{
		...
		var categoria = document.getElementById('categoria').value;
		var tipo_producto = document.getElementById('tipo_producto').value;
		imprimir_inf("consulta_semaforo_verde.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&categoria='+categoria+'&tipo_producto='+tipo_producto+'&t_despacho='+t_despacho,'mediano');
	}
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      <td><table width="587" border="0"  cellpadding="0" align="center">
                        <tr>
                          <td colspan="5"  class="ctablasup" >SEMAFORO</td>
                        </tr>
                        ...
                        <tr>
                          <td class="ctablablanc" >Fecha Inicial </td>
                          <td class="ctablablanc" ><input name="fec_ini" type="text" class="textotabla01" id="fec_ini" readonly  />
                          ...
                          <td class="ctablablanc" >Fecha Final </td>
                        ...
                        <tr>
                          <td class="ctablablanc" >&nbsp;</td>
                          <td class="ctablablanc" >&nbsp;</td>
                          <td class="ctablablanc" ><div align="center">TIEMPO DE DESPACHO </div></td>
                          <td class="ctablablanc" >&nbsp;</td>
                          <td aling='center' >&nbsp;</td>
                        <tr>
                          <td width="91" class="ctablablanc" >&nbsp;</td>
                          <td width="149" class="ctablablanc" >&nbsp;</td>
                          <td width="136" class="ctablablanc" ><div align="center">
                            <input name="t_despacho" type="text" id="t_despacho" size="10" onKeyPress="return validaInt_1()">
                          DIAS</div></td>
                          <td width="98" class="ctablablanc" >&nbsp;</td>
                          <td aling='center' >&nbsp;</td>
                        <tr>
                          <td class="ctablablanc" >&nbsp;</td>
                          <td class="ctablablanc" >&nbsp;</td>
                    ...
                    <tr>
                      <td height="30" align="center" valign="bottom"><table width="256" height="43">
                        <tr>
                          <td width="55" height="37" bgcolor="#CC0033"><div align="center"><span class="ctablablanc">
                          <input type='hidden' name='codigo2'>
                          <img src='imagenes/mirar.png' width='16' height='16'  style="cursor:pointer"  onclick="abrir_rojo()" /></span>                       
                          </div>
                          <td width="29">                          
                          <td width="59" bgcolor="#FFFF99">
                            <div align="center"><span class="ctablablanc">
                            <input type='hidden' name='codigo22'>
                          <img src='imagenes/mirar.png' width='16' height='16'  style="cursor:pointer"  onclick="abrir_r_a()" /></span>                            </div>
                          <td width="32">                          
                          <td width="57" bgcolor="#009900"><div align="center"><span class="ctablablanc">
                          <input type='hidden' name='codigo222'>
                        <img src='imagenes/mirar.png' width='16' height='16'  style="cursor:pointer"  onclick="abrir_verde()" /></span> </div>                        </tr>
                      </table></td>
                    </tr>
                  </table>
      </form>
