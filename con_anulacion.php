...
$where_cli="";
$sql2="select distinct punto_venta.cod_bod as valor , nom_bod as nombre from punto_venta  
...
if($det==0)
	$where.=" where cod_fac>0   and  ( $where_cli )  and tipo_fac is null ";
                    ...
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==10) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_anulacion.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
