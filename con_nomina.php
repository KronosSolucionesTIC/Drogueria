...
if($det==0)
	$where.=" where cod_mov > 0 AND tipo_mov = 11";
...
$where AND estado_mov = 1 ORDER BY cod_mov  DESC";
...
<form id="forma_total" name="forma_total" method="post" action="man_nomina.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_nomina.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                    ...
                    <tr>
                      <td><table width="755" border="0"  cellpadding="0">
                        <tr>
                          <td width="70"  class="ctablasup">TIPO MOVIMIENTO</td>
						...
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_nomina.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_mov' action='man_nomina.php'>  ";
							echo "<td >$db->nom_tmov</td>";
...
<form name="forma" method="post" action="con_nomina.php">
