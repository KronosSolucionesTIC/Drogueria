...
function abrir() {	 // cierre normal	
	...
	else 
	{
		...
		var cod_usu = document.getElementById('usuario').value;
		imprimir_inf("inf_ventas_usuario.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin+'&cod_usu='+cod_usu,'mediano');
	}
}
    ...
    <td valign="top" ><table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
        <tr>
          <td><table width="587" border="0"  cellpadding="0" align="center">
              <tr>
                <td colspan="4"  class="ctablasup" >INFORME DE VENTAS X VENDEDOR</td>
              </tr>
              <? 
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						?>
              <tr>
                <td class="ctablablanc" >Vendedor:</td>
                <td class="ctablablanc" ><? combo_evento_where("usuario","usuario","cod_usu","nom_usu"," ","  ", " where estado_usuario = 1 ORDER BY nom_usu"); ?></td>
