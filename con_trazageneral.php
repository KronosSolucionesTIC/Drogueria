...
<form id="forma_total" name="forma_total" method="post" action="informes/inf_traza_total.php" enctype="multipart/form-data">
                  ...
                  <table width="710" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
                      ...
                      <td width="710" bgcolor="#D1D8DE"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td height="27" colspan="7"><div align="center" class="subfongris">ROTACI&Oacute;N GENERAL </div></td>
                        </tr>
                        <tr>
