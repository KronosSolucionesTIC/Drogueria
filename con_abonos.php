...
//$sql="SELECT   abono.cod_abo,  abono.cod_bod_Abo,  abono.val_abo,  abono.cod_usu_abo,  abono.fec_abo, abono.cod_rso_abo,  bodega1.nom_bod,   usuario.nom_usu,  rsocial.nom_rso FROM   abono   left JOIN bodega1 ON (abono.cod_bod_Abo = bodega1.cod_bod)  left JOIN usuario ON (abono.cod_usu_abo = usuario.cod_usu)   left JOIN rsocial ON (abono.cod_rso_abo = rsocial.cod_rso) $where ORDER BY cod_abo  DESC ";
 ...
 $sql="SELECT * , CONCAT(bodega1.nom_bod,apel_bod) as cliente 
 FROM   abono 
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_abonos.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_abonos.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
						...
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_abonos.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_abo' action='man_abonos.php'>  ";
							echo "<td >$db->fec_abo </td>";
							echo "<td >$db->cod_abo </td>";
							echo "<td >$db->val_abo </td>";
...
<form name="forma" method="post" action="con_abonos.php">
