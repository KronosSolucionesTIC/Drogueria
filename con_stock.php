...
var dato =document.getElementById('codigo').value;
		window.open("formatos/ver_lista_stock.php?codigo="+dato,"ventana","menubar=0,resizable=1,width=900,height=600,toolbar=0,scrollbars=yes")
}
                  ...
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    ...
                    <tr>
					  ...
					  <table width="524" border="0"  cellpadding="0" align="center">
                        <tr>
						  <td width="322"  class="ctablasup" >OPCION POR BODEGAS </td>
						...
						?>
							      ...
							      <td >Bodega 
						        <? combo_evento_where("codigo","bodega","cod_bod","nom_bod"," ","  ", " where estado_bodega = 1"); ?></td>
							        <td aling='center' >
							<table width='100%' border='0' cellspacing='0' cellpadding='0'>
                            <tr>  <td align='center'> <input type='hidden' name='codigo'></td>
                         
							<td align='center'>
					<INPUT type="button" value="Det. Lista" class="botones" onClick="verdatalle()">
					</td>
                            </tr> </table>  </td>
							<?
