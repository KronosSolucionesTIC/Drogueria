...
<TABLE border="0" cellpadding="2" cellspacing="0"  width="306" <?=$anulacion?> >
			...
			<TR>
			  <TD><table width="200" align="center" border="0"  id="select_tablas">
                <tr >
                ...
                <tr id="fila_0"  >
				  ...
				  <? echo  $db->cod_fry_pro." ".substr($db->nom_pro,0,20) ; ?>
				  <? } else {?>
                  <? echo  substr($db->nom_pro,0,20); ?>
				  <? } ?>
                  </span></td>
			...
			if( !empty($obs_fac) ) {
			?>
			<table width="200" border="0" align="center" class="forms1">
              <tr>
                <td>
