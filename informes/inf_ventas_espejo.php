...
var url="ver_factura_v_esp.php?codigo="+dato;
...
<body  <?=$sis?>>
 <!--SELECCION PROVEEDOR Y FECHA-->
  <table width="643" align="center" class="subfongris">
    <tr>
      ...
      <td width="229">INFORME DE VENTAS ESPEJO </td>
      <td width="196">&nbsp;</td>
    </tr>
</table>
  <?  
 if ($fechas2==0) {
	  ...
	  $fecha = "AND m_factura_esp.fecha>='$fechas' 
	  ";
	...
	$fecha = "AND m_factura_esp.fecha>='$fechas' AND m_factura_esp.fecha<='$fechas2' 
	";
...
$dbg->query($sqlg);
 ...
 $ciudad=$dbg->ciu_bod;
  ...
  bodega1.nom_bod,
  bodega1.ciu_bod,
  m_factura_esp.cod_fac,
  m_factura_esp.fecha,
  m_factura_esp.cod_cli,
  m_factura_esp.cod_bod as bodega
FROM
  bodega1
  INNER JOIN m_factura_esp ON (bodega1.cod_bod = m_factura_esp.cod_cli)
WHERE bodega1.ciu_bod='$ciudad'  $fecha  AND estado IS NULL group by m_factura_esp.cod_cli"; 
...
$code=$dbt->cliente;  
 $cont=$cont+1;  
  ...
  m_factura_esp.cod_fac,
  m_factura_esp.cod_cli,
  m_factura_esp.cod_bod,
  m_factura_esp.num_fac,
  m_factura_esp.fecha,
  m_factura_esp.tot_fac,
  bodega1.cod_bod,
  bodega1.nom_bod,
...
FROM
  ...
  INNER JOIN bodega1 ON (m_factura_esp.cod_cli = bodega1.cod_bod)
   INNER JOIN bodega ON (m_factura_esp.cod_bod = bodega.cod_bod)
  WHERE m_factura_esp.cod_cli='$code'  $fecha "; 
