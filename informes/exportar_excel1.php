...
WHERE cod_rso=$combo_empresa AND m_factura.estado IS NULL and fecha BETWEEN '$fechas' AND '$fechas2'
...
?>
  ...
  <table width="310" border="1" align="left">

    <tr>
      <td><input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
          <input type="hidden" id="contador2" name="contador2" value="<?=$j?>" />Total:</td>
        <td><div align="right">
          $
