...
if($cod_bod == 0){	
	$busqueda = "(bodega.cod_bod = 340 OR bodega.cod_bod = 363 OR bodega.cod_bod = 375 OR bodega.cod_bod = 376)";
}
else{
	$busqueda = "bodega.cod_bod = $cod_bod";
}

if($cod_bod == 0){	
	$busqueda2 = "(centro_costos.cod_bod = 340 OR centro_costos.cod_bod = 363 OR centro_costos.cod_bod = 375 OR centro_costos.cod_bod = 376)";
}
else{
	$busqueda2 = "centro_costos.cod_bod = $cod_bod";
}
