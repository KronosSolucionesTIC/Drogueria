...
<tr>
<td><table width="250" border="1" cellpadding="2" cellspacing="1"   class="textoproductos1" align="center">
    <tr>
      <td colspan="8" class="ctablasup" align="center"><?
if (!isset($global[2])) {
...
?>
  ...
  ?>
	...
	?>
        <br>
        <td colspan="3" class="subtitulosproductos" align="right"><?=$dbra->desc_razon?>
          ;
          <?=$dba->obs_anulacion?></td>
      </tr>
      <? 
    ...
    <form method="POST" action="consulta_caja_diara1.php" name="enviar_correo">
      ...
      <tr>
        <td align="center" colspan="8"><input name="button3" type="button" class="botones1"  onclick="guardar_correo()" value="Enviar" />
          ...
          <input name="button" type="button" class="botones1"  onClick="window.close()" value="Cerrar" />
...
<table width="306" border="1" cellpadding="2" cellspacing="1"   class="textoproductos1" align="center">
    <? 
