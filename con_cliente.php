...
if($eliminacion==1) {//confirmacion de insercion  
	$error=eliminar("bodega1",$eli_codigo,"cod_bod");
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_cliente.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#D1D8DE"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_cliente.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
  						  <td width="147"  class="ctablasup">NOMBRE</td>
						  <td width="66"  class="ctablasup">NIT</td>
						  <td width="151"  class="ctablasup">DIRECCION</td>
						  <td width="69"  class="ctablasup">CIUDAD</td>
						  <td width="65"  class="ctablasup">RUTA</td>
                          <td  class="ctablasup"  width="112">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_cliente.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_bod' action='man_cliente.php'>  ";
...
<form name="forma" method="post" action="con_cliente.php">
