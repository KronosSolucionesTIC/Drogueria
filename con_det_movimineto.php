...
function MM_jumpMenu(targ,selObj,restore){ //v3.0
  ...
  if (restore) selObj.selectedIndex=0;
	...
	function abrir() {	
		...
		if(document.getElementById('fec_fin').value == ""  ||  document.getElementById('fec_ini').value=="" ||  document.getElementById('vendedor').value==0) {
			...
			imprimir_inf("inf_detalle_movi.php",'0&fec_ini='+fec_ini+"&fec_fin="+fec_fin+"&vendedor="+vendedor,'mediano');
                    ...
                    <tr>
					  ...
					  <table width="624" border="0"  cellpadding="0">
						...
						?>
							  ...
							  <tr>
							    <td ><? combo_evento("vendedor","vendedor","cod_ven"," nom_ven ",$dbdatos->cod_ven_inv,"", "nom_ven"); ?></td>
